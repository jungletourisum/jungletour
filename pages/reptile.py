...
### load file
uploaded_file = st.file_uploader("Choose a image (jpg or png)")
...
map_dict = {0: 'BlacklippedLizard',
            ...
            17:'Cannot Identified This is Not a Reptile Image or Modal Havent This Data'
            }
...
if uploaded_file is not None:
    ...
    if Genrate_pred:
        ...
        if prediction == 9 :
                    st.header('Common Wolf Snake Lycodon capucinus', divider='green')
                    st.subheader('Kingdom :blue[Animalia]')
